                    ...
                    <div class="card">
                        <div class="header">
                            <h2>
                               ...
                               <a href="../view/view_pressing_return.php"><input type="submit" name="submit" class="btn btn-danger" value="View Product" style="float: right;"></a>
                        ...
                        <div class="body">
                            <form method="POST" action="../model/update_pressing_data.php">
                            <div class="row clearfix">
                                <div class="col-sm-6">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="submit" class="btn btn-danger form-control" name="pressing_return_update" value="ADD PARTS"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
