                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="table-responsive">
							 ...
							 $receive_id=$_GET['id'];
                             $sql = "SELECT * FROM receive_pressing where product_name='$receive_id'";
                             ...
                             while ($row = mysqli_fetch_array($query)) {
                                 ...
                                 $minus = $sub_quantity-$receive_quantity;
                             ...
                             ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="../invoice/invoice_receive_pressing.php?id=<?php echo $id; ?>"><input type="submit" name="bill" value="Generate Bill" class="btn btn-danger"></a> 
