                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <?php
                             ...
                             $sql = "SELECT * FROM receive_transfer  ORDER BY id DESC LIMIT 1";
                             ...
                             ?>
                                        <tr>
											...
											<td><?php echo $faq; ?></td>
                                            <td>
												<a href="../invoice/invoice_receive.php?id=<?php echo $product_name; ?>"><input type="submit" name="bill" value="Generate Bill" class="btn btn-danger"></a> <br><br>
                                                <a href="../view/view_receive_transfer_one_history.php?id=<?php echo $product_name; ?>"><input type="submit" name="bill" value="Transfer History" class="btn btn-primary"></a> 
											...
											<?php 
													if($faq == 0){
																	echo '<input type="button" value="Received" class="btn btn-success">';			
																}
															else 
																{
																	echo '<input type="button" value="Pending" class="btn btn-warning">';			
																}
											?>			
											</td>
