...
$pdf->Cell(189,10,'',0,1);
 include ('../api/conn.php');
                    // $total = 0;
                $receive_id=$_GET['id'];
                $sql = "SELECT * FROM receive_transfer where product_name='$receive_id'";
...
include('../api/conn.php');
	...
	while($res = mysqli_fetch_array($res1))
	{
		$supplier_location=$res['supplier_location'];
